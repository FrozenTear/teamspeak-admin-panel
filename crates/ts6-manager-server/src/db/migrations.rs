...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "0009_bot_flow_run",
        include_str!("../../migrations/0009_bot_flow_run.surql"),
    ),
    (
        "0010_admin_audit_log",
        include_str!("../../migrations/0010_admin_audit_log.surql"),
    ),
    (
        "0011_moderation",
        include_str!("../../migrations/0011_moderation.surql"),
    ),
    (
    ...
    (
        "0015_moderation_token",
        include_str!("../../migrations/0015_moderation_token.surql"),
    ),
    (
        "0016_moderation_appeal_filed_action_kind",
        include_str!("../../migrations/0016_moderation_appeal_filed_action_kind.surql"),
    ),
    (
        "0017_moderation_appeal_action_kinds",
        include_str!("../../migrations/0017_moderation_appeal_action_kinds.surql"),
    ),
];
